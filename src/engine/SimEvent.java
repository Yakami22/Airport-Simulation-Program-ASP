...
public abstract class SimEvent implements Comparable<SimEvent> {
	...
	public EntiteSimulee getEntitePorteuseEvenement() {
		return entitePorteuseEvenement;
	}

	public void setEntitePorteuseEvenement(EntiteSimulee entitePorteuseEvenement) {
		this.entitePorteuseEvenement = entitePorteuseEvenement;
	}
